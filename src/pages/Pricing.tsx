...
const PLANS = [
  ...
  },
  {
    ...
    monthly: { price: 25000, planKey: "pro_plan" as const },
    yearly: { price: 240000, planKey: "pro_plan" as const },
    features: [
      "1 restaurant",
      "Staff illimité",
      "Analytics avancés",
      ...
      "Sécurité 2FA & sauvegardes",
      "Exports CSV/Excel & journal d'audit",
      "Support email",
    ],
    cta: "Passer Pro",
    highlight: true,
  ...
  },
  {
    ...
    monthly: { price: 75000, planKey: "business_plan" as const },
    yearly: { price: 720000, planKey: "business_plan" as const },
    features: [
      "Tout Pro inclus",
      "Multi-restaurants",
      ...
      "Analytics avancées & rapports consolidés",
